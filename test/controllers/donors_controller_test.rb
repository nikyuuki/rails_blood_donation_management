...
class DonorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donor" do
    assert_difference("Donor.count") do
      post donors_url, params: { donor: { bloodtype: @donor.bloodtype, icnum: @donor.icnum, name: @donor.name, phone: @donor.phone } }
    end
  ...
  test "should update donor" do
    patch donor_url(@donor), params: { donor: { bloodtype: @donor.bloodtype, icnum: @donor.icnum, name: @donor.name, phone: @donor.phone } }
